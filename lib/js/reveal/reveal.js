 ...
 * modified from 3.8.0
 * refactor by adding recycle for unbinding event
 */
...
(function( factory ) {
	...
	function recycle() {
		...
		document.removeEventListener( 'msvisibilitychange', onPageVisibilityChange, false );
		document.removeEventListener( 'webkitvisibilitychange', onPageVisibilityChange, false );
	}
